...
|---|---|---|
| **Joseph** | `constants.py`, `models/` (all 7 model files) | Data layer — domain models, named constants, persistence |
| **Anna** | `ui/console.py`, `ui/auth_ui.py`, `services/auth_service.py`, `services/station_service.py`, `services/candidate_service.py`,`store.py` | UI framework — colors, formatting, authentication flow |
